    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 node_5674 = (ambient*node_5108);

                float node_6982 = dot(lightDirection,i.normalDir);
                float3 node_2495 = (node_5108*round(node_6982)*_LightColor0.rgb);
                return fixed4((node_5674*0.6*node_2495),0);
            }
            ENDCG
        }
        Pass {
...
////// Emissive:
                ...
                float node_9366 = (2.0*_Texture_var.b);
                float3 node_5108 = (lerp(lerp((_DarkColor.rgb*_Texture_var.r),_ColorR1.rgb,saturate(node_3837)),_ColorR2.rgb,saturate((node_3837-1.0)))+lerp(lerp((_DarkColor.rgb*_Texture_var.g),_ColorG1.rgb,saturate(node_62)),_ColorG2.rgb,saturate((node_62-1.0)))+lerp(lerp((_DarkColor.rgb*_Texture_var.b),_ColorB1.rgb,saturate(node_9366)),_ColorB2.rgb,saturate((node_9366-1.0))));
                float3 node_5674 = (UNITY_LIGHTMODEL_AMBIENT.rgb*node_5108);
                float3 emissive = node_5674;
                float node_6982 = dot(lightDirection,i.normalDir);
                float3 node_2495 = (node_5108*round(node_6982)*(_LightColor0.rgb*attenuation));
                float3 finalColor = emissive + node_2495;
